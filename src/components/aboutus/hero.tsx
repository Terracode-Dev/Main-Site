...
export default function Hero2 (){
  ...
  return (
    ...
    animate={controls} 
    className='flex flex-col items-center h-auto xl:py-20 py-10 space-y-5 text-center md:space-y-8 lg:space-y-10 mt-[15%] sm:mt-0'>
      {/* Title */}
      ...
      <div className='xl:w-2/3 h-[300px] md:h-[600px] rounded-xl bg-cover p-1'>
        <img src='/team.png.jpeg' alt="Team image" className='object-cover w-full h-full rounded-xl'/>
      </div>
    </motion.div>
    </>
  )
