      ...
      <div className='flex flex-col items-center justify-center w-full gap-8 py-8 xl:gap-14'>
        ...
        <div className='flex items-center justify-center w-2/3 px-4 text-center'>
          <h1 className='text-2xl font-semibold leading-tight sm:text-3xl md:text-5xl xl:text-6xl'>
            Build Your Applications with <span className='animate-gradient bg-[length-1]  bg-gradient-to-r from-[#EF3D00] to-[#FDA40A] bg-clip-text text-transparent'>Robust,Scalable</span> and <span className='bg-gradient-to-r from-[#EF3D00] to-[#FDA40A] bg-clip-text text-transparent'>Secure</span> Technology
          </h1>
        </div>
