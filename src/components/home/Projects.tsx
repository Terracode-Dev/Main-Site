  ...
  return (
    <div className='flex items-center justify-center px-4 mx-auto'>
      <div className='flex flex-col items-center justify-center w-full gap-8 py-8 xl:gap-14'>
        {/* Title */}
        <div className='flex items-center justify-center w-2/3 px-4 text-center inter'>
          <h1 className='text-2xl font-semibold leading-tight sm:text-3xl md:text-5xl xl:text-6xl inter'>
            Build Your Applications with <span className="animate-flowing-gradient bg-gradient-to-r from-[#EF3D00] to-[#FDA40A] bg-[length:200%] bg-clip-text text-transparent inter"> Robust, Scalable </span>and <span className='animate-flowing-gradient bg-gradient-to-r from-[#EF3D00] to-[#FDA40A] bg-[length:200%] bg-clip-text text-transparent inter'>Secure</span> Technology
          </h1>
        </div>
