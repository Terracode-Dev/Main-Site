...
export default function Projects() {
  return (
    <div className='container flex items-center justify-center h-screen mx-auto border-2'>
      <div className='flex flex-col items-center justify-center w-full gap-8 py-8 space-y-2'>
        {/* Title */}
